...
Real-Time Multiplayer Social Platform (Gather-Town-like)

Social Square is a browser-based multiplayer social environment where users can move around shared 2D spaces, see other players in real time, and communicate via proximity-based voice chat.
The project focuses on low-latency real-time systems, room lifecycle management, and scalable WebRTC communication, rather than visual polish alone.

1. Problem Statement

Most social platforms optimize for feeds and messages, not presence.
Social Square explores how to create a feeling of shared space on the web, where:
...
Client emits movement updates

Server relays updates to room participants
...
Live deployment: (link if you want to add it)
...
Read-only access can be provided for interview or evaluation purposes upon request.
